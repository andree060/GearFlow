            ...
            <table class="table table-bordered table-striped table-hover shadow-sm rounded-3">
                ...
                <tbody>
                    @foreach ($manutencao as $manutencaos)
                        <tr>
                            <td class="align-middle">{{ $manutencaos->id }}</td>
                            <td class="align-middle">{{ $manutencaos->equipamento->nome }}</td>
                            <td class="align-middle">{{ \Carbon\Carbon::parse($manutencaos->data_manutencao)->format('d/m/Y') }}</td>
